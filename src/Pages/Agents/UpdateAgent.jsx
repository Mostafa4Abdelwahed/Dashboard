        ...
        <div>
            <Container>
                <header className="flex justify-between mt-5">
                    <h1 className="text-2xl font-bold">تعديل المكتب</h1>
                </header>
                ...
                <FormControl>
                    <Button onClick={handleSubmit} loadingText='جاري التعديل' className="my-7 w-full" colorScheme='teal'>تعديل المكتب</Button>
                </FormControl>
            </Container>
        </div>
    )
