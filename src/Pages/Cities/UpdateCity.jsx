        ...
        <div>
            <Container>
                <header className="flex justify-between mt-5">
                    <h1 className="text-2xl font-bold">تعديل المدينة</h1>
                </header>
                ...
                <FormControl>
                    <Button onClick={handleSubmit} loadingText='جاري الإضافة' className="my-7 w-full" colorScheme='teal'>تعديل المدينة</Button>
                </FormControl>
            </Container>
        </div>
    )
